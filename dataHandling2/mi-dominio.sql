...
CREATE TABLE movies ( id SERIAL PRIMARY KEY, title VARCHAR (50), synopsis VARCHAR (300), trailer_url VARCHAR (100), release_year DATE, genres_id INTEGER REFERENCES genres(id));
